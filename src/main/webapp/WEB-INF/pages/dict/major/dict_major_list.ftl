...
<html>
	...
	<body>
		...
		<div class="row">
			<div class="col-md-12">
				<form name="listform" action="${contextPath}/dict/edu/common/major/<@commonMacros.scope />/all/list" method="post"  class="form-horizontal" role="form">
						    ...
						    <div class="row ">
						    	...
						    	<div class="col-md-4">
									<div class="form-group ">
										<label class="col-md-5 control-label">专业名称：</label>
										<div class="col-md-7">
								...
								<div class="col-md-3">
									<div class="form-group ">
										...
										<div class="col-md-7">
											<@commonMacros.multiSelect staticlabel.standard "search" "_decm.standard" "${page.pageSupport.paramVo.map['_decm.standard']?if_exists}"/>
										</div>
									</div>
								</div>
								<!--/span-->
						...
						<div class="portlet-body">
									...
									<div class="col-md-6">
										<div class="btn-group">
											<a id="sample_editable_1_new" class="btn green-seagreen"
												href="${contextPath}/dict/edu/common/major/<@commonMacros.scope />/0/add${page.pageSupport.paramVo.parm?if_exists?html}">
												新增
											</a>
										</div>
									</div>
							...
							<table class="table table-striped table-bordered table-hover util-btn-margin-bottom-5" id="datatable_ajax">
								...
								<tr role="row" class="heading">
								    <th>所属目录</th>
								    <th>所属大类</th>
									<th class="sort_default" name="_decm.code" onclick="sortbyth(this)">专业编码</th>
									<th class="sort_default" name="_decm.title" onclick="sortbyth(this)">专业名称</th>
									<th >选用状态</th>
									<th >执行标准</th>
									<th >类别</th>
									<th >操作</th>
								...
								<tbody>
									...
									<tr>
									    ...
									    <td>
									    	<a class="font-blue-steel" href="${contextPath}/dict/edu/common/major/<@commonMacros.scope />/${one.id}/read${page.pageSupport.paramVo.parm?if_exists?html}">
									    		<u>${one.title?if_exists}</u>
									    	</a>
									    </td>
									    <td>
									    	<@commonMacros.multiSelect staticlabel.status "list" "status" "${one.status?default(1)}"/>
									   		<a class="font-blue" href="javascript:changeDictStatus(this, ${one.status?default(1)}, '${contextPath}/dict/edu/common/major/<@commonMacros.scope />', ${one.id?if_exists}, '${page.pageSupport.paramVo.parm?if_exists?html}');" >
									    ...
									    <td class="td_btn_width_2">
									    	...
									    	<a class="btn btn-xs green-seagreen" href="javascript:updateDictRecord('${contextPath}/dict/edu/common/major/<@commonMacros.scope />', ${one.id?if_exists}, '${page.pageSupport.paramVo.parm?if_exists?html}');">
											<i class="fa fa-edit"></i>修改</a>
											<a class="btn default btn-xs black" href="javascript:deleteDictRecord(this, '${contextPath}/dict/edu/common/major/<@commonMacros.scope />', ${one.id?if_exists}, '${page.pageSupport.paramVo.parm?if_exists?html}');">
												删除 </a>
											</#if>
									    </td>
									</tr>
