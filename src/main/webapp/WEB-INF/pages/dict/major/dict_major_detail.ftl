						...
						<div class="portlet-body form">
							<div class="form-horizontal form-body">
							    ...
							    <div class="form-group">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">专业编码</label>
										<div class="col-md-9"><p class="form-control-static">${major.code?if_exists}</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">原专业编码</label>
										<div class="col-md-9"><p class="form-control-static">${major.formerCode?if_exists}</div>
									</div>
