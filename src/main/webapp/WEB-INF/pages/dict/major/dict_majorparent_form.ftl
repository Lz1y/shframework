					...
					<div class="portlet box green-seagreen">
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal valid_form" commandName="dict" name="dictForm" method="post"
								action="${contextPath}/dict/edu/common/majorparent/<@commonMacros.scope />/${major.id?default(0)}/save${pageSupport.paramVo.parm?if_exists?html}" >
								...
								<div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label"><@commonMacros.requiredMark />校定专业代码</label>
										<div class="col-md-4">
											<@spring.formInput  "major.code" 'class="form-control required"  maxlength="20" placeholder="校定专业代码"'/>
											<@spring.showErrors "" "alert font-red" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label"><@commonMacros.requiredMark />校定专业名称</label>
										<div class="col-md-4">
											<@spring.formInput  "major.title" 'class="form-control required"  maxlength="50" placeholder="校定专业名称"'/>
											<@spring.showErrors "" "alert font-red" />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<@commonMacros.multiSelect groupmajor showStyle "pid" major.pid "required" />
											<@spring.bind "major.pid" />
											<@spring.showErrors "" "alert font-red" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-5">
											...
											<div class="radio-list">
												<label class="radio-inline">	
													<input name="standard" type="radio" value="1" checked="checked"/>
												<@commonMacros.multiLabel "list" "standard" "standard" major.standard?default(1) />
											</label>
											</div>
										</div>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<button type="button" class="btn default button-previous btn_cancel"  onclick="location.href = '${contextPath}/dict/edu/common/majorparent/<@commonMacros.scope />/all/list${pageSupport.paramVo.parm?if_exists?html}'">取消</button>
										</div>
									</div>
								</div>
							</form>
