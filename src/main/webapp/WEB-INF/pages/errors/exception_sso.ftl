...
<link id="style_color" href="${contextPath}/resources/metronic/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css"/>
...
<div class="row">
	<div class="col-md-12 page-404">
		<div class=" number">
			<#if msgType??>${msgType}</#if>
		</div>
		<div class=" details">
			<h3><#if errorMsg??>${errorMsg}</#if></h3>
		</div>
	</div>
</div>
</body>
