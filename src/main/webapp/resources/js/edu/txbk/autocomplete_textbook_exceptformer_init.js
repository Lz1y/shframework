 ...
 */
function autocomplete_textbook_exceptformer_ajax(nameSelector, idSelector, formerTextbookId){
	var data = {};
	$.ajax({
    	url: getContextPath() + '/edu/txbk/studenttextbookinstock/0/0/textbook/directaccess?formerTextbookId=' + formerTextbookId,
        type: "POST",
        async:true, 
    	data: data,
    	dataType: 'json',
